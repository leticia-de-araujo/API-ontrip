...
export class listUsers1662664799906 implements MigrationInterface {
    name = 'listUsers1662664799906'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL, "username" character varying(20) NOT NULL, "email" character varying(30) NOT NULL, "password" character varying(500) NOT NULL, "dateOfBirth" character varying(20) NOT NULL, "isAdm" boolean NOT NULL DEFAULT false, "isActive" boolean NOT NULL DEFAULT true, "photo" character varying(5000) NOT NULL, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
